...
class SFX extends Component {
  ...
  componentDidMount() {
    ...
    this.props.dispatch(addActiveTab("sfx"));
  ...
  render() {
    return (
      <>
        <Row>
          <Col>
            <h5>{this.props.t("balance_unlocked")} : {parseFloat(this.state.balance_unlocked).toFixed(10)} SFX</h5>
          </Col>
          <Col>
            <h5>{this.props.t("balance_locked")} : {parseFloat(this.state.balance_locked).toFixed(10)} SFX</h5>
          </Col>
        </Row>
        <Row>
          <Col>
